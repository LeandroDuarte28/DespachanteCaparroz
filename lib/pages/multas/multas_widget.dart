                                                                    ...
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          TextSpan(
                                                                            text:
                                                                                '🚨 Consultas e Pagamento de Multas de Trânsito\n\nLevar uma multa faz parte da rotina de muitos motoristas. O importante é regularizar sua situação o quanto antes para evitar problemas maiores. Com a Caparroz Despachantes, você consulta e paga suas multas de forma rápida, segura e sem sair de casa.',
                                                                            style:
                                                                                GoogleFonts.roboto(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                            text:
                                                                                '⚠️ O que acontece se eu não pagar as multas?\n\nSe você não pagar as multas:\n- Seu veículo não poderá ser licenciado\n- A dívida se acumula com juros e multas adicionais\n- A infração pode ser inscrita na Dívida Ativa\n- Você pode sofrer protesto em cartório\n- Pode haver restrição para vender ou transferir o veículo\n- Em casos mais graves, pode haver bloqueio judicial do veículo',
                                                                            style:
                                                                                GoogleFonts.roboto(
                                                                              fontWeight: FontWeight.w300,
                                                                              fontSize: 16.0,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                            text:
                                                                                '💰 Como faço para consultar o valor que devo pagar?\n\nPara saber o valor exato das multas, basta ter:\n- Número do Renavam\nPlaca do veículo\n- A Caparroz Despachantes faz a consulta para você em instantes e apresenta todas as informações: valores atualizados, prazos, pontos na CNH e possibilidade de parcelamento.',
                                                                            style:
                                                                                GoogleFonts.roboto(
                                                                              fontWeight: FontWeight.w300,
                                                                              fontSize: 16.0,
                                                              ...
                                                              child: RichText(
                                                                ...
                                                                text: TextSpan(
                                                                  children: [
                                                                    TextSpan(
                                                                      text:
                                                                          '📆 Quando devo pagar?\n\nVocê deve pagar a multa até a data de vencimento informada na notificação ou boleto da infração. O pagamento em até 30 dias após a emissão da multa pode garantir 20% de desconto se for feito dentro do prazo e sem contestação.',
                                                                      style: GoogleFonts
                                                                          .roboto(
                                                                        fontWeight:
                                                                            FontWeight.w300,
