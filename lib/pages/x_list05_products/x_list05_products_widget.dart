...
import 'x_list05_products_model.dart';
export 'x_list05_products_model.dart';

class XList05ProductsWidget extends StatefulWidget {
  const XList05ProductsWidget({super.key});

  static String routeName = 'xList05Products';
  static String routePath = '/xlist05Products';

  @override
  State<XList05ProductsWidget> createState() => _XList05ProductsWidgetState();
}

class _XList05ProductsWidgetState extends State<XList05ProductsWidget>
    with TickerProviderStateMixin {
  late XList05ProductsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XList05ProductsModel());
